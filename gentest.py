...
class TestGen():
    ...
    def ProcessFormData(self):
        ...
        f = [
            'first_name', 'last_name', 'date', 'course_name', 'course_number',
            'test_title', 'instructor_name'
        ]
    ...
    def ProcessTestQuestions(self,
        ...
        for i, j in zip(self.data['questions'],
                        range(1,
                              len(self.data['questions']) + 1)):
            ...
            if i['type'] == "true_false":
                ...
                for k, l in zip(x, y):
                    print(" ___ {} {}. {}".format(
                        str.ljust(k, 20), next(letters), str.rjust(l, 0)))
                if answerkey:
                    print("")
